...
yay -S --needed --noconfirm downgrade swayfx wlroots libva-nvidia-driver swaylock-git swayidle-git clipman sway-screenshot rustup persway wdisplays-git swayosd-git wlogout walker
