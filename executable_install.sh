...
yay -S --needed --noconfirm downgrade sway-nvidia wlroots libva-nvidia-driver swayidle-git clipman sway-screenshot rustup swaymgr wdisplays-git swayosd-git wlogout walker firefox coppwr-bin python-pywalfox hyprpicker nerd-fonts-git cohesion-git notion-calendar-electron nwg-look qogir-icon-theme materia-gtk-theme illogical-impulse-bibata-modern-classic-bin pfetch-rs-bin
