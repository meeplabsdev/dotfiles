...
yay -S --needed --noconfirm downgrade sway-nvidia wlroots libva-nvidia-driver swaylock-git swayidle-git clipman sway-screenshot rustup persway wdisplays-git swayosd-git wlogout walker firefox coppwr-bin python-pywalfox hyprpicker vscodium-bin vscodium-bin-marketplace
